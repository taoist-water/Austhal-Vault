...
Stress extends beyond just taking hits from weapons. It is the primary damage track for the world itself:

- **The Environment:** Severe weather and hazards (like a freezing blizzard or poisonous swamp) attack a character's Stress track before their Wounds. A character can literally freeze to death or die of exhaustion by maxing out their Stress Limit and entering the Death Spiral without ever taking a sword swing.
