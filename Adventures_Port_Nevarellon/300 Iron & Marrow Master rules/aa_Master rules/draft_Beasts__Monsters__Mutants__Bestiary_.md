...
- **Fodder:** * _Budget:_ +1 to +2 total points distributed across 1 Attribute or Skill.
	...
	- Vessel Limit 1. 
	- Fodder spend Threat freely, no leader required — any Fodder with a Threat Ability can use it whenever Threat is available, up to its Vessel Limit.
	- 1 wound. 
	- Stress Limit per the standard formula (4 + Will + Wits + Feat + Species bonus) — no tier-specific carveout.
