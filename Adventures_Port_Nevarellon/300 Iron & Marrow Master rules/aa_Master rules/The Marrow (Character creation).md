...
- Stone-Bones: Dwarves are incredibly dense. Their base Wound Threshold is increased by +1. (This is huge in this system, effectively granting them the hardiness of a higher Prowess score without breaking the Attribute cap).
...
- Athletics: Raw physical exertion (climbing, swimming, sprinting).
