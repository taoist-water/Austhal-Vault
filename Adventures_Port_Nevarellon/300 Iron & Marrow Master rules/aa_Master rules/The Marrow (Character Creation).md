...
* Mechanic: If you suffer a Minor or Major Wound from a melee attack, your nervous system rejects the shock. You may immediately spend 1 Momentum to perform a brutal, retaliatory Strike action against them. This occurs instantly before the Engagement ends and before you suffer any associated Stress penalties. *(A per-turn Momentum-spend cap is tracked in design-backlog.md — this is one of the abilities it would affect.)*
