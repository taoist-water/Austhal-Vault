...
- The Mechanic: Every time a character suffers a Wound, they must immediately permanently cross out 1 Inventory Slot on their sheet (starting from the bottom of The Pack).
    
- The Choice: If that Slot currently holds an item, the player must immediately drop that item in the dirt, or suffer 1 Dissonant Stress every single turn they continue to drag the excruciating weight.
