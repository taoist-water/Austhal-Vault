...
To take a Wound, an enemy's attack must overcome your physical durability, represented by your **Wound Threshold [T]** (calculated as 4 + Prowess + Armour + Species Bonuses + Scale bonus + Misc.mods). When a character loses a Clash, the resulting Impact dictates the severity of the Wound:
