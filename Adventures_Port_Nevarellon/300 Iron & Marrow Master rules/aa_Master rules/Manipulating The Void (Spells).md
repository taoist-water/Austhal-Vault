...
- Resolution: Unopposed Wits + Arcana vs. TN 8. (Targeting self or one ally in sight).
...
- Resolution: Unopposed Wits + Arcana vs. TN 8. (Can be cast as a Free Reaction).
...
- Resolution: Unopposed Wits + Arcana vs. TN 8. (Requires engaging the target in close range).
