...
_This list already matches every Type reference already written elsewhere in the system — Smite Corruption's "Undead, Daemons, or Mutants," Ward of the Threshold's "Undead or Void-Touched," Blade of Paranoia's "Construct." Those entries were the taxonomy before the taxonomy had a name; nothing upstream needs to change._
