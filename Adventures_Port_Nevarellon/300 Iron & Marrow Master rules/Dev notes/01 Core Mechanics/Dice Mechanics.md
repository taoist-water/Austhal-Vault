...
- Sometimes the degree of success matters, when this is the case, the following defines margins of success;
    - Margins of success:
	    ...
	    -  High Success (5 -11)
	    - Massive Success (12+)
- Fates Bounty (double 6s): When a natural double 6 is rolled, the player (or Elite/boss NPC)  rolls an additional die and addsit to the total. This is only done once.
