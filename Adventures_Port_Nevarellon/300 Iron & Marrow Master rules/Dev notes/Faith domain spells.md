# Faith Domains — Common Miracles and Domain-Exclusive Lists (Draft 1)

## Intro fix — replaces the current opening of "The Word on Domains"

> Faith domains represent direct divine intervention powered by rigid devotion. Every Miracle, regardless of Domain, resolves through the standard Tithe of Will — Will + Faith vs. TN 8, Locked Stress cost paid on Pass and Fail alike, GM gains 1 Threat on a Fail, Toll in Flesh on Snake Eyes — exactly as defined in Embracing the Abyss. What a Domain adds on top of that chassis is a unique aura, a specific prayer manifestation, and an exclusive list of Miracles only that Domain's faithful may learn.

---

# Common Miracle Tier

_Available to any Priest regardless of Domain, including a Heretic on the Heretic's Path._

### Healing / Stabilize

_(Already established — unchanged. Included here for reference.)_

- Level: Novice. Cost: 2 Locked Stress. Pass: clears 1 Wound Slot, Stabilizes if Incapacitated.
...
_Paragon: Saint Senecus the Unyielding. Tactical duty over survival — these Miracles reward discipline and holding the line, never panic._
...
- Fail: As Pass, and the GM gains 1 Threat (in this specific case, the warning and the cost arrive together).
...
# Domain of Trickery (The Cult of the Crooked Coin)

_Paragon: Corvo's Folly. Outsmarting rigged systems — these Miracles bend luck, identity, and consequence rather than confronting anything head-on._

### Loaded Dice

A murmured joke, a flick of the wrist — the universe's ledger gets quietly cooked.

- **Level:** Novice
- **Cost:** 1 Locked Stress
- **Target/Range:** One character (self, ally, or enemy), Short Range
- **Action Type:** Reactor

**The Tithe Ladder:**

- Pass: Force a reroll of any single die just rolled (yours, an ally's, or an enemy's) — the new result stands, even if worse.
- Fail: As Pass, and the GM gains 1 Threat.
- Snake Eyes: The reroll happens, but convert the cost into a direct Wound.
...
# Remaining Domains — Thematic Plan Only (not yet written)

|Domain|Paragon|Angle for its 4 Miracles|
|---|---|---|
|Law|Aurelius the Architect|Has Banish already. Add: reassign _Ward of the Threshold_ here (perfect fit for Smite Corruption's theme), plus a truth-compelling Miracle and an offensive radiant smite.|
|Death|Vael the Mute|Mercy-killing, anti-reanimation, silence, and a "the dead stay dead" ward against Necromancy specifically.|
|Winter & Wilds|Kaelen the Survivor|Frost damage, survival/endurance buffs, a fear-howl, and an ice-armor ward.|
|Mercy & Healing|Mother Elara|Has Resurrection already. Add: a group heal (absorbing rot from many at once), a Priest-takes-the-condition swap, and a disease/poison cure with Elara's specific "I absorb it" framing.|
|The Sea & Storms|Thalass's Omen|Offensive wave/drowning damage, a calm-the-storm or summon-the-storm utility, a brine-armor ward, and a dread-of-the-deep AoE.|

If this lands — same Tithe Ladder shape, same ~4-per-Domain target, same "1-2 Locked Stress for Novice, 2-3 for Adept, 3+ for Master" cost scale — say so and I'll write all five out in full next.