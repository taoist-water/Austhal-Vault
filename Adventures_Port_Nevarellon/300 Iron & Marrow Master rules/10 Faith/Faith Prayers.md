...
### ADEPT SPELLS (Cost: Difficult Channelling: -2 to roll)

- Aura of Courage (Buff): Channelling. While active, you and all allies within 30 feet completely ignore the negative dice penalties (-1, -2, -3) caused by current Stress. You still suffer Wounds if you max out your Stress, but you fight at peak efficiency until you drop.
    
- Consecrate Weapon (Buff): Channelling. Touch a weapon. It glows with blinding light, gaining +2 Power, completely bypassing the natural resistances of supernatural creatures, and acting as a torch.
    
- Zone of Truth / Silence (Action): Channelling. You lock down a 20ft area. No one inside can speak a deliberate lie, OR all sound is entirely muted (making casting Arcana impossible inside the zone).
