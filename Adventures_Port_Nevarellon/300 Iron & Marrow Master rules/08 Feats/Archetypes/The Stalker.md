...
- Mechanic: When an enemy attempts to leave your Threat Zone and provokes a Free Aggressor action from you, your strike is devastatingly precise. You automatically roll the Clash with Advantage, and if you hit, the attack ignores 2 points of the target’s Armor rating when calculating their Wound Threshold.