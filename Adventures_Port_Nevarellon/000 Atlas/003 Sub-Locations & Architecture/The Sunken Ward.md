# District: The Sunken Ward
#location/district #status/solid

> "You want to know where I learned that mercy gets you drowned? Walk the Ward after dark and count how many doors still have people behind them." — Silas Bane

> "The docks flood twice a day with the tide. The Ward just never drains at all." — Common Port Nevarellon saying
...
## 🥖 Economy & Logistics
- **Primary Hubs:** [[The Muddy Docks|The Muddy Docks]] carries the Ward's entire functioning economy — dock labor, fencing, smuggling. Cinder Row has no comparable hub; its residents mostly work the Docks or the [[The Foundry Slips|Foundry Slips]] and return only to sleep.
- **Condition of Streets/Sanitation:** Worse than the Docks in Cinder Row specifically — no boardwalks or stilts, just packed ash-grey earth that turns to sucking mud in any real rain. Locals half-joke it's an echo of the same Ash-Blight that poisoned Corvus itself; it isn't, but the name stuck.
- **Key Resources/Utilities:** Fresh water carried in and sold by the barrel at the same exorbitant Docks rates. Cinder Row households more often go without, relying on shared rainwater cisterns split between a dozen families at a time.

---

## 📍 Key Locations & Sub-Locations
- [[The Muddy Docks|The Muddy Docks]] — *The Ward's waterfront neighborhood and economic engine; see its own entry for full detail.*
- **Cinder Row** — *Inland refugee tenement blocks. Deliberately left undeveloped here — a placeholder for future material rather than an oversight.*
