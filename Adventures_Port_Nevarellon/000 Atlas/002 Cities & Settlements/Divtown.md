# Settlement: Divtown
#location/settlement #status/solid

> "They call it the Baron's court, but it's just a pile of rot-wood and runaway slaves laundering pirate coin. The only thing keeping the Golden Company from burning it down is the fact that their ships need Divtown timber to float." — Quartermaster of the Watch

## 📊 City Profile
- **Type:** Smuggler's Shanty Town / Logging Outpost
