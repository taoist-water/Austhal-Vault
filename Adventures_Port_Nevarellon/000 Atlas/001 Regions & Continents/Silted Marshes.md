...
- **Primary Routes:** There are no roads. Travel is strictly by water through "The Grey Veins"—the endlessly winding, identical-looking muddy channels. Navigating requires flat-bottomed skiffs, push-poles, and a local guide who can read the subtle currents.
- **Travel Time to Port Nevarellon:** 4 to 7 days by skiff to the northern docks. Travel time is entirely unpredictable due to shifting sandbars and sudden localized fogs. Land travel by foot or horse is impossible; an armored man would drown in the mud within an hour.
- **Hazards & Terrain Difficulties:** The geography actively lies to you. A river channel deep enough to hide a pirate galleon one week might become an impassable wall of sucking mud the next. Endemic hazards include marsh-fever (carried by dense swarms of biting midges), infected drinking water, and quick-silt pits that resemble solid moss.
