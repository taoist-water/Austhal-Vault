...
1. **Orphaned ducal-seat names — need a decision.** The older tracker file named four ducal seats — **Millhaven** (Aerthos), **Saltmere** (Valerius), **Granite Spire** (Stonereach), **Corvus Spire** (Corvus) — plus an overland route, **The Ducal Concord Road**, and credited them to "The Five Duchies of the Whispering Coast.md (formalized as the seat)." I checked the actual document: **none of these names appear in The_Five_Duchies_of_the_Whispering_Coast.md.** That file only describes each duchy's terrain/seat generically (e.g., "heavily fortified stone keeps"). None of the four seat names or the road have dedicated files, and a vault-wide search turns up zero other references to Millhaven, Saltmere, or Granite Spire anywhere. "Corvus Spire" has a little more grounding — it's used as wikilink display text in The_Inner_Sea.md pointing at the Duchy of Corvus section — but it was never independently declared as the seat's proper name in prose.
   **Read:** this was drafted content that got written into a tracker but never actually committed to the source document or given files — a process gap, not a contradiction between two true things.
   **My recommendation:** the names are good — they fit the "-Spire" throughline already flagged for Stonereach/De Vonce/Corvus, and Millhaven/Saltmere read as plausible, distinct seat names for Aerthos/Valerius. Worth keeping rather than discarding. But I'd want your go-ahead before I write them into The_Five_Duchies_of_the_Whispering_Coast.md and spin up stub files, since it touches a document that already has an epigraph and established structure — flagging per the check-before-structural-changes rule rather than just doing it.
   **Until decided:** treated below as *proposed, not yet canon* — kept in the Locations table but marked unconfirmed rather than merged silently into the confirmed rows.
...
|---|---|---|---|---|
| Austhal | Top-level continent | The known continent; contains Whispering Coast, Silted Marshes, Inner Sea, Chalced Kingdom, Wastelands | Austhal.md, History - The Broken Crown of Austhal.md | Region list conflicts with Whispering Coast.md's own hierarchy — see next row. **Still open.** |
...
| Castle Iron-Spire | Duchy of De Vonce, northern foothills of the Jagged Spine | Ancestral seat of House De Vonce | Named only in Tythius De Vonce.md | **Reconciled entry.** Confirmed empty stub (checked directly) — needs its own content pass. Not actually named in The_Five_Duchies_of_the_Whispering_Coast.md itself, despite one prior tracker draft crediting that document — see Merge finding #1 |
...
| *Millhaven* (proposed seat of Aerthos) | Would be: Duchy of Aerthos, river/barge-channel confluence | Proposed: fortified grain-hub feeding Port Nevarellon's barge trade | **Not in any narrative document** — appears only in a prior tracker draft | **UNCONFIRMED — see Merge finding #1.** No file exists; zero other references in the vault |
...
| *Saltmere* (proposed seat of Valerius) | Would be: Duchy of Valerius, coastal cliffs | Proposed: walled port town over the salt-refining pans | **Not in any narrative document** — appears only in a prior tracker draft | **UNCONFIRMED — see Merge finding #1.** No file exists; zero other references in the vault |
...
| *Granite Spire* (proposed seat of Stonereach) | Would be: Duchy of Stonereach, mountain passes bordering Ubaraz | Proposed: dwarven-engineered citadel cut into the passes | **Not in any narrative document** — appears only in a prior tracker draft | **UNCONFIRMED — see Merge finding #1.** No file exists; zero other references in the vault |
...
| *Corvus Spire* (proposed name, ancestral seat of Corvus) | Would be: buried under the Corvus Scar | Ancestral seat of House Corvus, destroyed and buried in the Cataclysm; never excavated | Used only as wikilink display text in The_Inner_Sea.md, pointing at the Duchy of Corvus section | **PARTIALLY UNCONFIRMED — see Merge finding #1.** Has slightly more grounding than the other three proposed seats (an actual in-vault reference), but was never declared as the seat's proper name in prose, and no dedicated file exists. House Corvus is functionally extinct regardless; no road or lawful travel time to this location |
| *The Ducal Concord Road* (proposed) | Would be: overland route, Port Nevarellon ↔ Castle Iron-Spire ↔ Granite Spire, spur to Millhaven | Proposed: primary jointly-funded overland highway linking Port Nevarellon to the inland ducal seats | **Not in any narrative document** — appears only in a prior tracker draft | **UNCONFIRMED — see Merge finding #1.** Would complement, not replace, the confirmed Coastal Meridian sea-lane (The Inner Sea.md), which is real and would remain Saltmere's primary route if Saltmere is adopted |
...
| The Chalced Kingdom | Region south of Silted Marshes | Exiled royal bloodline's kingdom; slaving economy; sends "Retrievers" north | Referenced in Silted Marshes.md, History.md, Captain Haren Twarde.md, Telorna Belaar.md, Maccorrack.md | **NO FILE EXISTS — still the single highest-priority location gap.** Load-bearing for multiple NPC backstories and now indirectly for the Golden Company's own stated vulnerabilities (see "The Chalced Question" in The Golden Company.md) |
...
| The Broken Spires | Sub-location, submerged near Inner Sea | Petrified ruin matching Corvus Spire architecture; hints incursion tore out to sea | The Inner Sea.md | Documented inline — fine as is |
...
| Captain Haren Twarde | Wyvern Tail Pirates | High Captain; ex-Chalced navigator; wields the Wyvern-Hide Banner | N | Captain Haren Twarde.md | Alive |
...
| Maccorrack | Iron-Anchor Syndicate (muscle) | Half-orc stevedore/bodyguard; escaped Chalced slave | N | Maccorrack.md | Alive |
...
| Same era | Flight of the royal heir | A surviving royal child flees south through the Silted Marshes, founding the Chalced Kingdom | Chalced Kingdom's founding line | History.md |
...
| ~15 years ago | Haren unites the Wyvern Tail Pirates | Mutiny against a Chalced naval captain, then consolidation of independent raiders | Haren Twarde, Chalced Kingdom Navy | Captain Haren Twarde.md |
...
1. **The Chalced Kingdom** — still no file at all; the single highest-priority remaining gap, now touched by the Golden Company's own stated vulnerabilities as well as three NPC backstories.
2. **Orphaned ducal-seat names (NEW)** — Millhaven, Saltmere, Granite Spire, Corvus Spire, and The Ducal Concord Road exist in a prior tracker draft but were never written into The_Five_Duchies_of_the_Whispering_Coast.md or given files. Needs a decision: formalize into canon, or drop. See Merge finding #1 above.
